...
* @lastrevision Date:Tue, 14 Feb 2012 20:51:24 GMT
...
if(version_compare(JVERSION,'1.7.0','ge')) {
	...
	require_once (JPATH_BASE.DS.'components/com_content/views/article/view.html.php');
...
class ContentViewArticle2 extends ContentView
{
	function display($tpl = null)
	{
		...
		$mod_article_prams	=& $this->get('mod_article_prams'); // mod_article_prams
		
		$params->merge($mod_article_prams);
