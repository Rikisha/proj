...
$(document).ready(function(){
    ...
    // Add bg tops
    $('ul.menu li ul.level0').before('<div class="bg-top-curves">&nbsp;</div>');
    $('ul.menu li ul li ul.level1, ul.menu li ul li ul.level2').before('<div class="bg-top">&nbsp;</div>');
    }
    // ** If single width menu **
    if ($('ul#magemenu-top').hasClass('menu-single')) {
    // Add bg tops
    $('ul.menu-single li ul.level0').before('<div class="bg-top-curves">&nbsp;</div>');
    $('ul.menu-single li ul li ul.level1, ul.menu-single li ul li ul.level2').before('<div class="bg-top">&nbsp;</div>');
    }
