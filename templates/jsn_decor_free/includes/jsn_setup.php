 ...
 */
	...
	// Template color: blue | red | green | purple | orange | darkblue
	$template_color = $this->params->get("templateColor", "darkblue");

	/* Template text style:
	   1 - Business / Corporation
	   2 - Personal / Blog
	   3 - News / Magazines */
	$template_textstyle = $this->params->get("templateTextStyle", "personal");
