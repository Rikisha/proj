...
<?php
	...
	#jsn-content_inner1 {
		left: '.$left_width.'%;
		background: url('.JURI::root(true).'/templates/'.$this->template.'/images/backgrounds/jsn-content-sep-line.png) left top repeat-y;
	}
	#jsn-content_inner2 {
		left: -'.$left_width.'%;
	}
	...
	#jsn-content_inner3 {
		right: '.$right_width.'%;
		background: url('.JURI::root(true).'/templates/'.$this->template.'/images/backgrounds/jsn-content-sep-line.png) right top repeat-y;
	}
	#jsn-content_inner4 {
		right: -'.$right_width.'%;
	}
	...
	div.jsn-hasinnerleft #mainbody-content-inner1 {
		left: -'.$tw.'%;
		background: url('.JURI::root(true).'/templates/'.$this->template.'/images/backgrounds/mainbody-content-sepline.png) right top repeat-y;
	}
